...
internal class AudioPlaylist private constructor(val files: List<File>, initialIndex: Int) {
    ...
    companion object {
        fun create(opened: File, accepts: (File) -> Boolean): AudioPlaylist {
            ...
            return AudioPlaylist(files, files.indexOfFirst { sameFile(it, opened) }.coerceAtLeast(0))
        }
